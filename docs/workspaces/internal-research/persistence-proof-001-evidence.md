...
| schema initialization creates only the two authorized tables | passed |
...
- Expanded hammer coverage now includes duplicate-create, required-field, runtime, agent, external-reference, authorized-table, and file-backed SQLite persistence guard checks.
